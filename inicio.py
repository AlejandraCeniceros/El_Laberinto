...
def checar_colisiones():
    ...
    if xCarrito +0.15 > xLaberinto1 -0.15 and  xCarrito -0.05 < xLaberinto1 and yCarrito +0.05 > yLaberinto1 - 0.15 and yCarrito - 0.05< yLaberinto1 + 0.15:
        colisionando = True
    else:
        colisionando = False
